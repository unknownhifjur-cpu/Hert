...
import { Search, Heart, ArrowLeft, X, MoreVertical } from "lucide-react";
...
const ConversationSidebar = ({ currentUserId }) => {
  ...
  return (
    <div
      className={`${currentUserId ? "hidden md:flex" : "flex"} flex-col md:w-80 lg:w-96 w-full h-full`}
    ...
    >
      ...
      <div className="relative flex-shrink-0" style={{ minHeight: "200px" }}>
        ...
        />
        <div
          className="absolute top-4 right-16 w-16 h-16 rounded-full opacity-20"
          style={{ background: "#a855f7" }}
        />
        <div
          className="absolute top-12 right-6 w-10 h-10 rounded-full opacity-30"
          style={{ background: "#ec4899" }}
        />
        <div
          className="absolute bottom-8 left-8 w-8 h-8 rounded-full opacity-20"
              ...
              <li key={conv.user._id}>
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p
                      className={`text-xs truncate mt-0.5 ${conv.unread ? "font-semibold text-gray-700" : "text-gray-400"}`}
                    >
                      {conv.lastMessage}
                    </p>
                  </div>
