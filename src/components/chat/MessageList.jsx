...
const MessageList = ({
  ...
  const isMessageEditable = (msg) => {
    const isSender = msg.sender._id === currentUser._id || msg.sender._id === currentUser.id;
      ...
      <div className="max-w-2xl mx-auto">
        ...
        {partnerTyping && (
          <div className="flex items-end gap-2">
            ...
            <div className="px-4 py-3 rounded-2xl rounded-bl-md flex gap-1 items-center" style={{ background: '#f3f4f6' }}>
